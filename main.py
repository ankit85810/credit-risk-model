...
with row1[1]:
    income = st.number_input('Income', min_value=0, value=1400000)
with row1[2]:
    loan_amount = st.number_input('Loan Amount', min_value=0, value=2680000)
...
with row2[2]:
    avg_dpd_per_delinquency = st.number_input('Avg DPD', min_value=0, value=25)
